...
export const ProfilePage = () => {
  ...
  return (
    <div className="profilePage">
      <h1 className="profilePage__head" onClick={() => console.log(userData.user_name)}>Welcome, <span className="profilePage__head-part">
        {isAdmin ? adminData.admin_name : userData.user_name}
      </span></h1>
